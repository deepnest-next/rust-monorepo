...
export declare function loadSvgString(svgData: string, dpiScale?: number | undefined | null): LoadSvgResult
export declare function loadSvgFile(svgPath: string, dpiScale?: number | undefined | null): LoadSvgResult
